...
Start_time =   pd.to_datetime("2024-02-24")
...
# json.dump(cedar_template, f, ensure_ascii=False, indent=4)
# f.write(cedar_template)
#print the type of data 
#save data to a json file
# save data to a json file with name test 
